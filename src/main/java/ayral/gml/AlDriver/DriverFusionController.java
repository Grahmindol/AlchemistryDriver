...
public final class DriverFusionController extends DriverSidedTileEntity {

    @Override
    public Class<?> getTileEntityClass() {
        return TileFusionController.class;
    }

    @Override
    public ManagedEnvironment createEnvironment(World world, BlockPos pos, EnumFacing side) {
        return new Environment((TileFusionController) world.getTileEntity(pos));
    }

    public static final class Environment extends ManEnv<TileFusionController> implements NamedBlock {
        public Environment(final TileFusionController tileEntity) {
            super(tileEntity, "fusion_controller");
        }
        ...
        @Callback(doc = "function():boolean -- Return if fusion controller can process.")
